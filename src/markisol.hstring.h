...
Successful capture, full command is: 01110100100011111000001110000011000001101
...
// ----------------------------------------------------------------------------------------------------------------------------------------------------------------
void sendShortMarkisolCommand(char *command, char *remote_id, char *channel)
{
